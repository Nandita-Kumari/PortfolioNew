      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          <img
            ...
            src={"https://github-readme-stats.vercel.app/api?username=Nandita-Kumari&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false"}
            alt="Nandita"
            loading="lazy"
          />
        </ItemLayout>
        ...
        <ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
          <img
            className="w-full h-auto"
            src={"https://github-readme-stats.vercel.app/api?username=Nandita-Kumari&theme=dark&hide_border=true&type=svg&background=EB545400&ring=FEFE5B&currStreakLabel=FEFE5B"}
            alt="CodeBucks"
            loading="lazy"
          />
        </ItemLayout>
        ...
        <ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
          ...
          >
            <img
              className="w-full h-auto"
              src={"https://github-readme-stats.vercel.app/api?username=Nandita-Kumari&repo=Nextjs-contentlayer-blog&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false&description_lines_count=2"}
              alt="CodeBucks"
              loading="lazy"
            />
          </Link>
